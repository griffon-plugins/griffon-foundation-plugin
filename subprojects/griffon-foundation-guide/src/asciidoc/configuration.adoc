...
----
dependencies {
    griffon '{project-group}:griffon-foundation-plugin:{project-version}'
}
----
...
----
dependencies {
    compile '{project-group}:griffon-foundation-swing:{project-version}'
}
----
...
----
dependencies {
    compile '{project-group}:griffon-foundation-javafx:{project-version}'
}
----
...
----
dependencies {
    compile '{project-group}:griffon-foundation-swing-groovy:{project-version}'
}
----
...
----
dependencies {
    compile '{project-group}:griffon-foundation-javafx-groovy:{project-version}'
}
----

== Maven

First configure the `griffon-foundation-plugin` BOM in your POM file, by placing the following
